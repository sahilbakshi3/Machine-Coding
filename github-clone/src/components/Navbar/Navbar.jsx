...
const Navbar = () => {
  ...
  const navLinks = ["Product", "Solutions", "Open Source", "Pricing"];
    ...
    <header className={`navbar ${scrolled ? "navbar-scrolled" : ""}`}>
      <div className="navbar-inner">
        ...
        <nav className="navbar-links">
          {navLinks.map((link) => (
            <a key={link} href="#" className="nav-link">
              {link} <ChevronDown size={14} className="nav-chevron" />
            </a>
          ))}
        </nav>
        ...
        <div className="navbar-actions">
          <a href="#" className="nav-action-link">
            Sign In
          </a>
      ...
      {mobileOpen && (
        <div className="mobile-menu">
          ...
          <a href="#" className="btn-signup mobile-signup">
            Sign Up
          </a>
        </div>
      )}
